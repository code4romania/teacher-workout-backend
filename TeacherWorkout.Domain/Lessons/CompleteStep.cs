...
public class CompleteStep(IStepRepository stepRepository, ILessonStatusRepository lessonStatusRepository) : IOperation<StepCompleteInput, StepCompletePayload>
{
