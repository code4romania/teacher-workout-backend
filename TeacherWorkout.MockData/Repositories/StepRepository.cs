...
namespace TeacherWorkout.MockData.Repositories
{
    public class StepRepository : IStepRepository
    {
        ...
        public ILessonStep SubmitAnswer(string id, IEnumerable<string> answerIds)
        {
            return GetStepWithLesson(id);
        }

        private static ILessonStep GetStepWithLesson(string id)
        {
            switch (id)
            {
                case "1":
